...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('img/brand/icommits.png') }}" type="image/png">
    <!-- Fonts -->
    ...
    <footer class="py-5" id="footer-main">
        ...
        <div class="row align-items-center justify-content-xl-between">
            ...
            <div class="copyright text-center text-xl-left text-muted">
                &copy; 2020 <a href="#" class="font-weight-bold ml-1" target="_blank">MyusufH882</a>
            </div>
            </div>
            <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-xl-end">
                <li class="nav-item">
                <a href="#" class="nav-link" target="_blank">MyusufH882</a>
                </li>
                <li class="nav-item">
